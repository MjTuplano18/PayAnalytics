...
import { DollarSign, Users, FileText, Landmark, Waypoints, Hash, BarChart3, ChevronDown, Check } from "lucide-react";
...
export default function DashboardPage() {
  ...
  const [activeTab, setActiveTab] = useState<"overview" | "touchpoints">("overview");
  ...
  return (
    <div className="px-4 sm:px-8 py-8 min-h-screen">
      ...
      <div className="flex gap-0 border-b border-gray-200 dark:border-gray-700 mb-6">
        {(["overview", "touchpoints"] as const).map((tab) => (
          <button
            key={tab}
          ...
          >
            {tab === "overview" ? "Overview" : "Touchpoints"}
          </button>
        ))}
      </div>
